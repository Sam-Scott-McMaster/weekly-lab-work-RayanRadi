...
#define HST 15       // Harmonized Sales Tax (modified to 15%)
...
// #define WINDOWS       // Commented out to simulate Unix-based OS

/* Note the alternate syntax with the BEGIN and END macros */
void main()
BEGIN
    #ifdef WINDOWS
        printf("Running on Windows OS\n");
    #else
        printf("Running on Unix-based OS\n");
    #endif
